...
const Auth = produce((state, action) => {
  switch (action.type) {
    ...
    case GET_USER_DATA_AFTER_LOGIN_SUCCESS:
      state.alluserdataafterlogin = action.payload[0];
      console.log(
        "reducer success register----> payload from mobile verification<----",
        action.payload
      );
    ...
    case ADD_SECONDARY_EMAIL_SUCCESS:
      ...
      return {
        ...
        alluserdataafterlogin: [
          {...state.alluserdataafterlogin[0], secondaryEmailVerify: action.payload}
      ...
      return {
        ...
        alluserdataafterlogin: [
          {...state.alluserdataafterlogin[0], secondaryMobile: action.payload}
      ...
      return {
        ...
        alluserdataafterlogin: [
          {...state.alluserdataafterlogin[0], secondaryMobileVerify: action.payload}
      ...
      return {
        ...
        alluserdataafterlogin: [
          {...state.alluserdataafterlogin[0], primaryEmailVerify: action.payload}
