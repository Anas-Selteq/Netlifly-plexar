...
import { getuserdataafterlogin, sendotpsecondary } from "../../Store/Auth/actions";
          ...
          <div className="col-md-6">
            ...
            <p className="mb-0 sub_text_color_account_alltext_show_actual">
              {getdataofregistereduser.secondaryEmail === "" ? (
                <span onClick={()=>history.push("/add-secondary-email")}>Add Secondary Email</span>
              ) : getdataofregistereduser.secondaryEmail ? (
                <>
                {getdataofregistereduser.primaryEmailVerify === true ? (
                <span onClick={resendotponcall}>{getdataofregistereduser.secondaryEmail}</span>
