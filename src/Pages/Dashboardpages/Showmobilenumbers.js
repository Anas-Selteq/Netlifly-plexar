...
import { getuserdataafterlogin, resendotpmobile, resendprimaryotpmobile, sendotpsecondary } from "../../Store/Auth/actions";
        ...
        <div className="row">
          <div className="col-md-6">
            ...
            {getdataofregistereduser?.primaryMobileVerify === true ? (
              ...
              <span onClick={resendotponcallprimarymobile}>{getdataofregistereduser?.primaryMobile}</span>
            )}
             </>
           ) : null}&nbsp;&nbsp;{isLoading ? (
          ...
          <div className="col-md-6">
            ...
            <p className="mb-0 sub_text_color_account_alltext_show_actual">
              {getdataofregistereduser.secondaryMobile === "" ? (
                <span onClick={()=>history.push("/add-secondary-mobile-number")}>Add Secondary Mobile Number</span>
              ) : getdataofregistereduser.secondaryMobile ? (
                <>
                {getdataofregistereduser.primaryEmailVerify === true ? (
                <span onClick={resendotponcallmobile}>{getdataofregistereduser.secondaryMobile}</span>
