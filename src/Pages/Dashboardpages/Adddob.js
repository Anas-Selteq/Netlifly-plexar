...
import { adddob, getallgenders, getuserdataafterlogin, resendotpmobile, sendgender, sendotpsecondary } from "../../Store/Auth/actions";
      ...
      <div className="col-md-12 px-0 pb-2 pt-3">
        <p className="mb-0 sub_text_color_account_alltext">Date of Birth</p>
                     ...
                     <input
                        ...
                        type="date"
                      />
 <button className="btn btn-primary mt-4 px-5" onClick={adddobdunc}> Save </button>
